...
- **Inflação Subjacente (_Core Inflation_)**: Medida de inflação que exclui a
  volatilidade transitória ou temporária dos preços. Mede a tendência para a inflação.
...
A inflação torna-se **permanente** quando as tendências de inflação se incorporam nas **expectativas**
da população.
...
A inflação pode resultar do lado da procura ou do lado da oferta, visto que preços e salários resultam da interação entre
...
- O apoio governamental na **prestação de cuidados infantis** (atribuição de licenças de maternidade/paternidade,
  por exemplo) incentiva a **participação feminina** no mercado de trabalho.

### Divisão de Output

O mercado de trabalho determina a divisão da produção da economia entre trabalhadores empregados, desempregados
e empregadores (proprietários das empresas).
...
$$
  \text{Coeficiente de Gini} = \frac{\text{Área entre a Linha de Igualdade e a Curva de Lorentz}}{\text{Área abaixo da Linha de Igualdade}}
$$
