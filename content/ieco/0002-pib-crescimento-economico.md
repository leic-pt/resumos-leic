...
- **[Recessão](color:red)**: período em que o output está em declínio, apresentando crescimento negativo durante **dois trimestres consecutivos**;
- **[Contas Nacionais](color:green)**: sistema utilizado para medição da produção e da despesa num país.

## Produto Interno Bruto

O Produto Interno Bruto (**[PIB](color:blue)**) de um país corresponde à soma de **tudo o que
...
Alterações na Taxa de Crescimento do PIB estão também negativamente correlacionadas com a **Taxa de Desemprego**.

$$
\text{Diminuição do Output} \rightarrow \text{Diminuição do PIB} \rightarrow \text{Aumento do Desemprego}
$$
...
- **Investimento** ($I$): Despesas com novos [bens de capital](/ieco/mercados-eficiencia-governo#economia-e-capitalismo), infraestruturas de rendimento a longo prazo
...
## Flutuações e Choques

### Choque

:::tip[Choque]

Um evento inesperado que provoca uma flutuação mais acentuada do PIB.

Choques ocorrem tanto em sociedades industrializadas como agrárias.

São exemplos de choques os fenómenos climáticos extremos e desastres naturais (secas, cheias, furacões, sismos, ...), as guerras, as pandemias, entre outros.
...
As decisões de investimento são tomadas de acordo com as **expectativas** em relação à **procura futura**, pelo que as empresas têm tendência para investir **ao mesmo tempo**.

:::

[O Investimento acaba por ser a **componente mais volátil do PIB**](color:red).

## Tecnologia

A **Tecnologia** é definida como sendo um processo que usa um certo número inputs para produzir um número de outputs. As tecnologias diferenciam-se entre si através das suas combinações específicas de inputs.

No exemplo apresentado abaixo, são dados cinco tecnologias diferentes que produzem 100 metros de tecido tendo como input o número de trabalhadores e a quantidade de carvão.

![Exemplo de cinco tecnologias que produzem o mesmo output](./assets/0002-tecnologias.png#dark=2)

Diz-se que uma tecnologia **[domina](color:yellow)** outra quando, produzindo o mesmo output, a primeira utiliza menos recursos do que a segunda. No exemplo apresentado, a tecnologia D é dominada pela B e a tecnologia C é dominada pela A.

As empresas tendem a escolher entre tecnologias com base no **preço relativo dos inputs**, que por sua vez está relacionado com a escassez relativa de cada um.

## Economia e Demografia

O estudo da **demografia** é essencial para estudar qualquer economia, dado que sem pessoas (trabalhadores e consumidores) não há economia.

Por exemplo, vários fatores de cariz demográfico, como o envelhecimento da população, baixa taxa de fertilidade, de imigração e elevada taxa de emigração provocam uma **diminuição da mão-de-obra** e, não havendo quem a substitua, origina uma diminuição generalizada da produção e, consequentemente, uma diminuição do consumo, do PIB, do crescimento económico e do bem-estar da população.

## Função de Produção

A **Função de Produção** representa o máximo de output que uma dada combinação de inputs consegue produzir.

**[Lei dos Rendimentos Médios Decrescentes](color:green)**: Se mantivermos um input e aumentarmos outro, a produção média por input diminui.
