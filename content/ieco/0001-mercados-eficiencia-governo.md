...
Uma alocação (resultado de uma interação económica) é **Pareto-eficiente** se ninguém
pode melhorar a sua situação sem piorar a situação de outros.
...
Tanto a curva da procura e como a da oferta podem movimentar-se devido a choques exógenos (como guerras, pandemias, fenómenos atmosféricos, entrada e saída de empresas do mercado, entre outros). Essas alterações podem se refletir em [**Contrações**](color:red), caso a curva se desloque para a esquerda, ou em [**Expansões**](color:green), caso a curva se desloque para a direita.
...
4. O preço diminui até se atingir um novo equilíbrio;

![Dilatação da Curva da Oferta](./assets/0001-dilatacao-da-curva-da-oferta.png#dark=2)
::::

### Elasticidade da Procura

Uma procura diz-se **elástica** caso pequenas mudanças de preço provoquem grandes alterações na quantidade
e **inlástica** caso contrário.

![Exemplo de Elasticidade da Procura](./assets/0001-elasticidade-da-procura.png#dark=2)

## Impostos

Os impostos são usados pelo Governo para obter receita e com eles fornecer bens e serviços benéficos para a
sociedade. Podem também ser utilizados para influenciar padrões de consumo, como, por exemplo, incentivar a
população a deixar de fumar aplicando um imposto sobre o tabaco.

A aplicação de impostos sobre os produtores desloca a curva da oferta e a aplicação de impostos sobre os
consumidores desloca a curva da procura, visto que, para a mesma quantidade, o preço torna-se mais alto.
O Excedente do Consumidor e o Excedente do Produtor reduzem-se e parte dessa perda representa a [**Receita
do Governo**](color:green), enquanto que o restante, a chamada Carga Excedente (em inglês, **Deadweight Loss** ou **DWL**),
representa o desperdício social provocado pela diminuição da eficiência.
...
**Bens Não Rivais:** São aqueles cujo uso por uma pessoa não reduz a sua disponibilidade
...
O resultado acaba por não ser uma alocação Pareto-eficiente, visto que o preço estabelecido pelas empresas
normalmente corresponde ao Custo Marginal Privado e não tem em conta o Custo Marginal Social

- [**Custo Marginal Privado (CMP)**](color:purple): Custo marginal para o decisor
- [**Custo Marginal Externo (CME)**](color:yellow): Custo imposto pelo decisor à sociedade
- [**Custo Marginal Social (CMS)**](color:green): CMP + CME; Custo total para a sociedade

![Custos Marginais](./assets/0001-externalidades.png#dark=2)

A primeira solução para este problema consiste na **Negociação** entre as entidades envolvidas. Consiste na
atribuição de direitos de propriedades à externalidade (como o direito a poluir ou o direito a ter ar limpo).
Usualmente consiste numa compensação monetária paga pelos terceiros às entidades envolvidas de modo a não reduzir
lucros e diminuir o Custo Marginal Social. O valor mínimo da compensação é igual aos lucros perdidos devido à
...
A existência de informação assimétrica resulta da [disparidade de informação](color:red) entre os dois ou mais grupos envolvidos
numa interação económica.

Um exemplo desta externalidade ocorre na concessão de empréstimos bancários, onde o devedor, caso possua
um menor rendimento, pode ter acesso limitado ao crédito ou pode mesmo ter o seu pedido de empréstimo recusado,
visto que o banco tem menos garantias de que este será pago na sua totalidade.
...
Assim, torna-se impossível utilizar contratos ou direitos de propriedade de forma a que todos os custos e
benefícios sociais sejam incluídos na tomada de decisão.

### Existência do Poder de Mercado

Uma empresa consegue adquirir poder sobre o seu próprio mercado devido a [concorrência reduzida](color:red) ou a
[reduções dos custos a médio e longo prazo](color:red). Este tipo de poder pode levar à imposição de
