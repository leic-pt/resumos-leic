...
![Tabelas de Dispersão](https://wikiimg.tojsiabtv.com/wikipedia/commons/thumb/7/7d/Hash_table_3_1_1_0_1_0_0_SP.svg/1200px-Hash_table_3_1_1_0_1_0_0_SP.svg.png#dark=2)
...
![Colisões](https://i.imgur.com/ZqF2crs.png#dark=1)
...
![Linear Probing](https://miro.medium.com/max/1400/1*DB-wlM36nme2lSmYyobpvA.gif#dark=2)
...
![via Procura Linear](./assets/0016-lin.png#dark=2)
...
![Double Hashing](https://scaler-topics-articles-md.s3.us-west-2.amazonaws.com/double-hashing-in-data-structure.gif#dark=2)
...
- Hits: $\frac{1}{\alpha}\log(\frac{1}{1- \alpha})$
