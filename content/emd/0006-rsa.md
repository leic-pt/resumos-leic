...
1. Escolhe-se e partilha-se uma codificação numérica para o tipo de mensagem a receber.
   ...
   ![Uma imagem](./assets/s/0017-asciiNum.png)
...
E a codificação:
![Uma imagem](./assets/0017-asciiNum.png)
...
**UPDATE:** Convém confirmar com os professores, mas em princípio podemos passar este passo à frente, a não ser que seja pedido no enunciado.
