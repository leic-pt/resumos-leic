...
O [comando `ALTER TABLE`](https://www.postgresql.org/docs/current/sql-altertable.html)
...
Podemos facilmente inserir dados em tabelas com o
[comando `INSERT`](https://www.postgresql.org/docs/current/sql-insert.html).
