...
Como $\frac a d \nmid \frac b d$ e $\frac b d \nmid \frac a d$, uma vez que são primos entre si, tal como vimos no [Teorema 5](#teorema-5), para existir solução, é preciso que  $\frac b d | (x-x_0)$, por exemplo. Se isto se verificar, então existe um $t \in \Z$, tal que:
...
Agora verificamos para que valor de $t$ é que $1 \leq m \leq 31$
