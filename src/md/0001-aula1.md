...
Dada uma sucessão $u_{n}$, tem-se que ($u_{n})' = \Delta u_{n} = u_{n+1}-u_{n}$. Neste caso, toma-se a definição usual de derivada (razão incremental), mas define-se $h = 1$ sempre.

<img src="./assets/0001-img1.png" width="90%">

A partir da imagem acima, é claro ver que a soma de todas as derivadas desde zero até $n-1$ é igual a $u_{n} - u_{0}$. Assim, tem-se
...
## Somas fechadas do tipo a levantado a n
...
**teorema 105 (pág 279)
secção 5.2 (pág 281) até onde conseguirem (3-4 páginas)**