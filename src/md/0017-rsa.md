...
Para todos os primos $p$ e $q$ distintos, para todo o $e \in \N$, tal que $e \frown (p-1)(q-1)$, então  
...
Nas resoluções dos testes este passo não é incluído. Não sei se é necessário na avaliação ou não. Se alguém souber diga.
